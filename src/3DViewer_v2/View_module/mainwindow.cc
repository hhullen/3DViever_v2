...
//    }
//    glview->show_message("Screenshot sved to: " + screenCap->files_path, 3000);
//  }
}
...
//    time->stop();
//    gif->save(file_name);
//    glview->show_message("Gif file saved to: " + screenCap->files_path, 3000);
//    recording = false;
//  }
}
...
void MainWindow::AddSteeringWidgetsToDockPanel() {
  ui_->scroll_area_contents->layout()->setAlignment(Qt::AlignTop | Qt::AlignLeft);
...
//  connect(screenCap, SIGNAL(take_screenshot()), this, SLOT(get_screen_shot()));
//  connect(screenCap, SIGNAL(record_gif()), this, SLOT(get_gif()));
}
